...
function runAnalysis(resumeText, jdText) {
  ...
  // Show premium section when analysis is done and reset premium subsections
  premiumSection.classList.remove('hidden');
  // Show pitch first and hide payment & premium tools
...
function generateCoverLetter() {
  ...
  if (lastOverallScore <= 80) {
    coverLetterTextArea.value = 'Match score is below 80%. A cover letter will not be generated. Please improve your resume for a better chance.';
    return;
  }
